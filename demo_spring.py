...
from diffusion_policy.env.spring.spring_keypoints_env import SpringKeypointsEnv
import pygame
...
def main(output, render_size, control_hz):
    ...
    # create Spring env with keypoints
    kp_kwargs = SpringKeypointsEnv.genenerate_keypoint_manager_params()
    env = SpringKeypointsEnv(render_size=render_size, render_action=False, **kp_kwargs)
